...
<CardGroup cols={2}>
  <Card title="Changing this title" icon="pen-to-square" color="red" href="https://mintlify.com/docs/quickstart">
...
Update your docs to your brand and add valuable content for the best user conversion. Adding content here
